...
**Focus:** Identify factors associated with recurrence using **Bayesian logistic modeling** and predictive analytics.  
**Outcome:** Interpretable estimates with uncertainty quantification to inform clinical risk understanding.
...
- Aggregated JSON data from **NSF** and **NIH** to align funding/activity features with publication counts.
